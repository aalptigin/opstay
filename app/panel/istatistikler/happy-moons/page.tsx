...
const DEFAULT_RESTAURANT: "Happy Moons" | "Roof" = "Happy Moons";
...
function MiniAreaChart({ title, labels, values }: { title: string; labels: string[]; values: number[] }) {
  ...
  // Nokta koordinatı = çizgi koordinatı => sapma imkansız
  const pts = useMemo(() => {
  ...
  // LINEER path: her noktanın üzerinden geçer (tam eşleşme)
